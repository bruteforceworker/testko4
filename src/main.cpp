...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "Bolan sm k svina, Anže je šel pa po leptop";
        CTransaction txNew;
        ...
        block.nVersion = 1;
        block.nTime    = 1410443604; //cetrtek, 11 Sep 2014 
        block.nBits    = bnProofOfWorkLimit.GetCompact();
        block.nNonce   = 2514284;
        ...
        assert(block.hashMerkleRoot == uint256("0xc044d69e966cf04d09feb22bd61b50da3d9c3c8a5f4732b2c49baac1c346e988"));//prej se je zacel na 7941...
